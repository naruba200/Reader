...
var ViterbiNode = class {
  constructor(node_name, node_cost, start_pos, length, type, left_id, right_id, surface_form) {
    __publicField(this, "start_pos");
    __publicField(this, "length");
    __publicField(this, "name");
    __publicField(this, "cost");
    __publicField(this, "left_id");
    __publicField(this, "right_id");
    __publicField(this, "prev");
    __publicField(this, "surface_form");
    __publicField(this, "shortest_cost");
...
var ViterbiLattice = class {
  constructor() {
    __publicField(this, "nodes_end_at");
    __publicField(this, "eos_pos");
    this.nodes_end_at = [];
...
var SurrogateAwareString = class _SurrogateAwareString {
  constructor(str) {
    ...
    __publicField(this, "index_mapping");
    this.str = str;
    this.index_mapping = [];
...
var ViterbiBuilder = class {
  constructor(dic) {
    ...
    __publicField(this, "token_info_dictionary");
    __publicField(this, "unknown_dictionary");
    this.trie = dic.trie;
...
var ViterbiSearcher = class {
  constructor(connection_costs) {
    __publicField(this, "connection_costs");
...
var Tokenizer = class _Tokenizer {
  constructor(dic) {
    __publicField(this, "token_info_dictionary");
    __publicField(this, "unknown_dictionary");
    __publicField(this, "viterbi_builder");
    __publicField(this, "viterbi_searcher");
...
var TokenInfoDictionary = class {
  constructor() {
    ...
    __publicField(this, "target_map");
    __publicField(this, "pos_buffer");
...
var ConnectionCosts = class {
  constructor(forward_dimension, backward_dimension) {
    __publicField(this, "forward_dimension");
    __publicField(this, "backward_dimension");
    __publicField(this, "buffer");
...
var CharacterClass = class {
  constructor(class_id, class_name, is_always_invoke, is_grouping, max_length) {
    __publicField(this, "class_id");
    __publicField(this, "class_name");
    __publicField(this, "is_always_invoke");
    __publicField(this, "is_grouping");
...
var InvokeDefinitionMap = class _InvokeDefinitionMap {
  constructor() {
    ...
    __publicField(this, "lookup_table");
    this.map = [];
    this.lookup_table = {};
  }
...
var CharacterDefinition = class _CharacterDefinition {
  constructor() {
    __publicField(this, "character_category_map");
    __publicField(this, "compatible_category_map");
    __publicField(this, "invoke_definition_map");
...
var UnknownDictionary = class extends TokenInfoDictionary_default {
  constructor() {
    super();
    __publicField(this, "character_definition");
    this.dictionary = new ByteBuffer_default(10 * 1024 * 1024);
    this.target_map = {};
    this.pos_buffer = new ByteBuffer_default(10 * 1024 * 1024);
  ...
  lookup(ch) {
    var _a;
    return (_a = this.character_definition) == null ? void 0 : _a.lookup(ch);
  }
  lookupCompatibleCategory(ch) {
    var _a;
    return (_a = this.character_definition) == null ? void 0 : _a.lookupCompatibleCategory(ch);
  }
...
var ConnectionCostsBuilder = class {
  constructor() {
    ...
    __publicField(this, "connection_cost");
    this.lines = 0;
...
var CharacterDefinitionBuilder = class {
  constructor() {
    __publicField(this, "char_def");
    __publicField(this, "character_category_definition");
    __publicField(this, "category_mapping");
...
var DictionaryBuilder = class {
  constructor() {
    __publicField(this, "tid_entries");
    __publicField(this, "unk_entries");
    __publicField(this, "cc_builder");
    __publicField(this, "cd_builder");
    this.tid_entries = [];
    this.unk_entries = [];
...
//# sourceMappingURL=@patdx_kuromoji.js.map
